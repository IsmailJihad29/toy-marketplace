    ...
    return (
        ...
        <div className="w-4/6 mx-auto mt-28">
            <div className="text-center mb-5">
                <h3 className="text-lg font-semibold uppercase font-primary">Grap Your Toys Based On</h3>
                <h1 className="text-3xl font-primary font-bold uppercase text-purple-500">Category</h1>
            </div>
      <Tabs>
        <TabList>
          <Tab>Avengers</Tab>
